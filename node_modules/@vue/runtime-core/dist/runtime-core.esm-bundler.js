...
import { isFunction, isString, isPromise, isArray, EMPTY_OBJ, isOn, EMPTY_ARR, extend, normalizeClass, isObject, normalizeStyle, isReservedProp, camelize, hasOwn, hyphenate, toRawType, capitalize, makeMap, NO, NOOP, remove, hasChanged, isGloballyWhitelisted } from '@vue/shared';
    ...
    const suspense = {
        ...
        registerDep(instance, setupRenderEffect) {
            ...
            instance
                ...
                hydratedEl ? null : next(instance.subTree), suspense, isSVG);
...
function createVNode(type, props = null, children = null, patchFlag = 0, dynamicProps = null) {
    ...
    const vnode = {
        ...
        ref: props !== null && props.ref !== undefined
...
function createHydrationFunctions(rendererInternals) {
        ...
        switch (type) {
            ...
            default:
                if (shapeFlag & 1 /* ELEMENT */) {
                    ...
                    mountComponent(vnode, container, null, parentComponent, parentSuspense, isSVGContainer(container));
    ...
    const hydratePortal = (vnode, parentComponent, parentSuspense, optimized) => {
        ...
        if (target != null && vnode.shapeFlag & 16 /* ARRAY_CHILDREN */) {
            hydrateChildren(target.firstChild, vnode, target, parentComponent, parentSuspense, optimized);
        }
        else if ((process.env.NODE_ENV !== 'production')) {
